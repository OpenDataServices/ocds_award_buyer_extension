...
```json
{
  ...
  "tender": {
    ...
    "description": "The Borough Council of Borsetdale and NHS Borsetdale Clinical Commissioning Group invites tenders from tenderers who wish to be considered for appointment to the All Age Domiciliary Care Services - Approved Provider List.",
    "value": {
      "amount": 9600000,
      "currency": "GBP"
    },
